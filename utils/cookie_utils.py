...
def save_profile_to_cookie(profile_data):
    ...
    try:
        ...
        # 使用更小的height并隐藏
        st.components.v1.html(cookie_script, height=1, scrolling=False)
        return True
...
def get_cookie_data():
    ...
    st.components.v1.html(cookie_reader_script, height=1, scrolling=False)
...
def clear_profile_cookie():
    ...
    """
    st.components.v1.html(clear_script, height=1, scrolling=False)
...
def check_cookie_support():
    ...
    """
    st.components.v1.html(check_script, height=1, scrolling=False)
